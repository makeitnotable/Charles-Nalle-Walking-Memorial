...
const LocationCard = memo(({ location, onNavigate }) => {
  ...
  return (
    ...
    >
      <div className='sm:h-40 lg:h-48 bg-primary-2 border-2 border-primary-3 text-white flex rounded-xl overflow-hidden mx-auto w-[343px] h-[128px] sm:w-[428.75px] sm:h-[160px] lg:w-[514.5px] lg:h-[192px]'>
        <div className='h-full'>
          <div className='w-[128px] h-[128px] sm:w-[160px] sm:h-[160px] lg:w-[192px] lg:h-[192px]'>
            {backgroundImage && (
              <img
        ...
        <div className='w-2/3 h-full p-3 flex flex-col justify-between'>
          <div className='flex flex-row justify-between items-center m-1'>
            <p className='uppercase text-[12px] sm:text-[15px] lg:text-[18px] font-normal font-poppins text-primary-11 leading-none mt-1'>Chapter</p>
            <div className='rounded-full w-[1rem] h-[1rem] sm:w-[1.25rem] sm:h-[1.25rem] lg:w-[1.5rem] lg:h-[1.5rem] flex justify-center items-center px-[6px] aspect-square bg-primary-10'>
              <p className='text-[.625rem] sm:text-[0.78125rem] lg:text-[.9375rem] font-medium font-poppins text-primary-12 leading-none mt-0.5'>{chapterNumber}</p>
            </div>
          </div>
          <div className='flex flex-col'>
            <div className='flex flex-col text-[1.125rem] sm:text-[1.40625rem] lg:text-[1.6875rem] font-medium font-["Martel_Sans"] text-primary-12 text-left leading-tight ml-1' >
              <p>{firstLine}</p>
