...
export default function HistoricalContextSection({ data }) {
  ...
  return (
    <div className='flex flex-col gap-y-8 md:gap-y-12 pt-8 md:py-4 lg:py-8 px-4' id="historical-context-section">
      ...
      <div className='flex flex-col md:flex-row gap-y-4 md:gap-y-0 md:gap-x-4 lg:gap-x-12'>
