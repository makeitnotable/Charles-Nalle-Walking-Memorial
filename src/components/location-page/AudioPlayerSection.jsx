                ...
                <div className="flex flex-row justify-between items-start">
                    <div className="flex flex-row justify-between items-start space-x-2">
                        <button
                            ...
                            className="w-16 h-16 bg-primary-4 border-2 border-primary-6 rounded-2xl flex items-center justify-center hover:bg-primary-5 transition-colors"
                        >
                            {isPlaying ? (
                                // Pause icon
                    ...
                    <div className='bg-primary-10 rounded-3xl px-2 py-1'>
                        <p className='text-primary-12 text-sm'>{formatTime(currentTime)}</p>
                    </div>
                </div>
            </div>
        </div>
