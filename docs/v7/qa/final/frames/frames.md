...
Base http://localhost:4321 · CPU throttle 4× · 2026-08-16T05:07:58.042Z
...
|---|---|---|---|---|---|---|---|
| map-card | 390 | 655 | 517 | 585 | js 0 () · img 0 () | 0px | CLEAN |
| continue | 390 | 602 | 565 | 566 | js 0 () · img 0 () | 0px | CLEAN |
| home-door | 390 | 616 | 543 | 658 | js 0 () · img 0 () | 0px | CLEAN |
| map-card | 1440 | — | — | — | js 0 () · img 0 () | 0px | NO-NAV |
| continue | 1440 | 626 | 576 | 569 | js 0 () · img 0 () | 0px | CLEAN |
| home-door | 1440 | 640 | 573 | 556 | js 0 () · img 0 () | 0px | CLEAN |
