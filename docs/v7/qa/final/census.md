...
| /map | 390 | **11** | 54, 40.5, 26, 19, 18.5, 18, 16, 15, 14, 12, 10 |
...
| /map | land | **11** | 74.1, 46, 26, 23.3, 22.5, 19, 16, 15, 14, 12.5, 12 |
...
| /map | 1024 | **11** | 112.6, 64, 28, 27, 25.2, 20, 16, 15, 14, 12, 11 |
...
| /map | 1440 | **10** | 128, 88, 30, 27, 26, 21, 16, 15, 13, 11 |
...
- **/map** — 128px t-wordmark · 88px t-display · 30px t-spine+t-title-sm · 27px (p) · 26px (p) · 21px t-prose · 16px (a) · 15px t-meta-body+btn+(p) · 13px (p)+t-meta · 11px (p)  ⚠ 3 size(s) shared by >1 role
...
- **/people** — "ONE DAY. A WHOLE CITY’S CAST." (2 lines/6 words) · "MARTIN I. TOWNSEND" (2 lines/3 words) · "BLUCHER HANSBROUGH" (2 lines/2 words) · "DEPUTY U.S. MARSHAL HOLMES" (2 lines/4 words)
