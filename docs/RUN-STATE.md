...
## CURRENT ITEM
P5 remainder: V8-328 drawer + V8-329 study are IMPLEMENTED and probed,
gating now (museum-check p5d + a11y paintings) → then V8-325 frames
(canvas recessed to ~0.01m proud of the slip; stepped rings; zero new
draw calls) → V8-327 arch + stairs → P7 full gate + REVIEW-GUIDE.

## NEXT ACTION
Commit V8-328 + V8-329 once museum-check p5d and a11y /paintings report,
then V8-325 (frames).
